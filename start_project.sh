...
echo -e "     ${YELLOW}curl http://localhost:$FASTAPI_PORT/health${NC}"
echo -e ""
echo -e "  2. Submit an analysis:"
echo -e "     ${YELLOW}curl -X POST http://localhost:$FASTAPI_PORT/analyze \\${NC}"
echo -e "       ${YELLOW}-F 'file=@your_file.stl' \\${NC}"
echo -e "       ${YELLOW}-F 'process_type=single'${NC}"
echo -e ""
echo -e "  3. Check job status:"
echo -e "     ${YELLOW}curl http://localhost:$FASTAPI_PORT/job/{job_id}${NC}"
echo -e ""
